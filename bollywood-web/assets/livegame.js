...
$(document).ready(function () {
  ...
  function betkeyrate(t2) {
    ...
    for (let t = 0; t < rowArr.length; t++) {
      ...
      if (t <= 6) {
        ...
        $("#betinnerdata_" + (8 + t)).html(dataObj[data].rate);
      }
    }
    $("#cardratetxt").html(`Cards : ${dataObj["card j"].rate}`);
  }
      ...
      t1.forEach(function (data, i) {
        ...
        if (gameStatust2 == 1 && timeLeftGame == 45) {
          ...
          function animationCallBack() {
            let m = Math.ceil(Math.random() * 35);
          ...
          function animationCallBack2() {
            let m2 = Math.ceil(Math.random() * 35);
  ...
  function randomChipPlaceHelper(tableId) {
    ...
    $("<div/>", {
      ...
      style: `background-image: url(/games/bollywood-web/assets/images/${
  ...
  function closebetsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/bollywood-web/assets/audio/stopbetting.mp3");
  ...
  function openbetsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/bollywood-web/assets/audio/startbetting.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function coinsSound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/bollywood-web/assets/audio/coinsound.wav");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function cardflip() {
    var audio = $("<audio>");
    audio.attr("src", "/games/bollywood-web/assets/audio/flipcard.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function wincupsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/bollywood-web/assets/audio/winsong.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  objPlayPauseMusic.src = "/games/bollywood-web/assets/audio/bgm.mp3";
