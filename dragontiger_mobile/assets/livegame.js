...
$(document).ready(function () {
  ...
  $(".stclss").hide();
  $(".secstyle").hide();
  $("#tigerbtnSection").hide();
  $("#tigerbtnSectioncard").hide();
  ...
  function betkeyrate(t2) {
    ...
    for (let t = 0; t < rowArr.length; t++) {
      ...
      if (t < 12) {
        ...
        $("#cardRate").html(`Cards ${dataObj["dragon card 1"].rate}`);
      }
    }
  }
  ...
  function randomChipPlaceHelper(tableId) {
    ...
    $("<div/>", {
      ...
      style: `background-image: url(/games/dragontiger_mobile/assets/images/${
  ...
  $("#dragonhbbtn").bind("click", function () {
    $("#tigerbtnSection").hide();
    $("#dragonbtnSection").show();
    $("#tigerbtnSectioncard").hide();
    $("#dragonbtnSectioncard").show();
    $("#cardsection1").show();
    $("#cardsection2").hide();
  ...
  $("#tigerhbbtn").bind("click", function () {
    $("#dragonbtnSection").hide();
    $("#tigerbtnSection").show();
    $("#dragonbtnSectioncard").hide();
    $("#tigerbtnSectioncard").show();
    $("#cardsection2").show();
    $("#cardsection1").hide();
  ...
  function closebetsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontiger_mobile/assets/audio/stopbetting.mp3");
  ...
  function openbetsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontiger_mobile/assets/audio/startbetting.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function coinsSound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontiger_mobile/assets/audio/coinsound.wav");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function cardflip() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontiger_mobile/assets/audio/flipcard.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function wincupsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontiger_mobile/assets/audio/winsong.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  objPlayPauseMusic.src = "/games/dragontiger_mobile/assets/audio/bgm.mp3";
