...
(function ($) {
  ...
  $.fn.extend({
    LoaderAnimation: function (customOptions) {
      ...
      var clear = function () {
        if (supportsCanvas) ctx.clearRect(0, 0, canvasWidth, canvasHeight);
        return true;
      };
      ...
      var draw = function () {
        ...
        $("#").css("left", LoaderProgressVal + "px");

        // console.log(LoaderProgressVal);
        $("#percentage").html(LoaderProgressVal);
        ...
        ctx.fillText(
          "Loading..." + (self.currentPercentage | 0) + "%",
          positionX - 8,
          positionY - 15
        );
