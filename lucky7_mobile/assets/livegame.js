...
$(document).ready(function () {
  ...
  function betkeyrate(t2) {
    ...
    for (let t = 0; t < rowArr.length; t++) {
      ...
      $("#playerOdsBtn_" + (1 + t)).html(dataObj[data].rate);
    }
  }
    ...
    try {
      ...
      t1.forEach(function (data, i) {
        ...
        if (gameStatust2 == 0 && timeLeftGame == 0 && hidden) {
          window.location.hash = "#dealerStyle";
          $(".settingprnt").hide();
          $("#gamestart").removeClass("betStart");
  ...
  function firstUserbetanim() {
    if (gameStatust2 == 1) {
      ...
      betChipFunctionHelper("#selectPoint_" + t);

      $("#" + clickqut + "chip-id").addClass("dummyuser_table" + t);
      coinsSound();
  ...
  function secondUserbetanim() {
    if (gameStatust2 == 1) {
      ...
      betChipFunctionHelper("#selectPoint_" + b);

      $("#" + clickqut + "chip-id").addClass("dummyuser2_table" + b);
      coinsSound();
  ...
  function betChipFunctionHelper(tableNo) {
    ...
    $("<div/>", {
      ...
      style: `background-image: url(/games/lucky7_mobile/assets/images/${j}_chip.png); top:${
        Math.random() * 100 + "%"
  ...
  function currentUserBetChipHelper(tablename) {
    ...
    $("<div/>", {
      id: clickqut + "chip-id",
      class: "betchipimgbgposition",
      style: `background-image: url(/games/lucky7_mobile/assets/images/${
  ...
  for (let i = 1; i < 7; i++) {
    $("#playerOdsBtn_" + i).bind("click", function () {
      betplacechippotion = i;
      isbet = true;
      $(".settingprnt").show();
    ...
    if (betplacechippotion < 7 && isbet) {
      ...
      betPlaceApiCall(
        API_TOKEN,
        {
          casinoName: 1,
          isBack: true,
          odds: liveOddsDataObj[betplacechippotion].rate,
          stake: amount,
          selectionId: liveOddsDataObj[betplacechippotion].sid,
        ...
        () => {
          ...
          coinsSound();
          currentUserBetChipHelper("#selectPoint_" + betplacechippotion);
          // $("#playerOdsBtn_" + betplacechippotion).addClass("selectBetBtn");
          $("#" + clickqut + "chip-id").addClass(
            "userBetPlaceAnim_" + betplacechippotion
          );
          const obj = {
            // option: "Single:0",
            amount,
          ...
          $("#selectPoint_" + betplacechippotion).addClass(
            "permanetchangebackground removepchbg"
          );
          betplacechippotion = 8;
        }
      );
    }
    isbet = false;
  ...
  function closebetsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/lucky7_mobile/assets/audio/stopbetting.mp3");
  ...
  function openbetsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/lucky7_mobile/assets/audio/startbetting.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function coinsSound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/lucky7_mobile/assets/audio/coinsound.wav");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function cardflip() {
    var audio = $("<audio>");
    audio.attr("src", "/games/lucky7_mobile/assets/audio/flipcard.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function wincupsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/lucky7_mobile/assets/audio/winsong.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  objPlayPauseMusic.src = "/games/lucky7_mobile/assets/audio/bgm.mp3";
