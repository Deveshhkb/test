...
$(document).ready(function () {
  ...
  function betkeyrate(t2) {
    ...
    for (let t = 0; t < mainData.length; t++) {
      ...
      liveOddsDataObj[1 + 3 * t] = dataObj[data].d;
      liveOddsDataObj[2 + 3 * t] = dataObj[data].t;
      liveOddsDataObj[3 + 3 * t] = dataObj[data].l;

      $("#betinnerdata_" + (1 + 3 * t)).html(dataObj[data].d.rate);
      $("#betinnerdata_" + (2 + 3 * t)).html(dataObj[data].t.rate);
      $("#betinnerdata_" + (3 + 3 * t)).html(dataObj[data].l.rate);
    }
  }
  ...
  function randomChipPlaceHelper(tableId) {
    ...
    $("<div/>", {
      ...
      style: `background-image: url(/games/dragontigerlion_web/assets/images/${
    ...
    if (confirmBet < 55 && isbet) {
      ...
      betPlaceApiCall(
        ...
        () => {
          ...
          if (drgnData.includes(confirmBet)) {
            coinsSound();
            ...
            confirmBet = 60;
          } else if (tgrData.includes(confirmBet)) {
            coinsSound();
            ...
            confirmBet = 60;
          } else if (lonData.includes(confirmBet)) {
            coinsSound();
  ...
  function closebetsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontigerlion_web/assets/audio/stopbetting.mp3");
  ...
  function openbetsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontigerlion_web/assets/audio/startbetting.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function coinsSound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontigerlion_web/assets/audio/coinsound.wav");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function cardflip() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontigerlion_web/assets/audio/flipcard.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  function wincupsound() {
    var audio = $("<audio>");
    audio.attr("src", "/games/dragontigerlion_web/assets/audio/winsong.mp3");
    audio.on("ended", removebg);
    if (!isMuted) {
      audio[0].play().catch(() => {});
    }
  ...
  objPlayPauseMusic.src = "/games/dragontigerlion_web/assets/audio/bgm.mp3";
