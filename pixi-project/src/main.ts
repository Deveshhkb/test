...
function placeCoin(targetArea: Graphics) {
  ...
  gsap.to(coinClone, {
    ...
    ease: "power2.out",
    onComplete: () => {
      placedCoins.push(coinClone as any);
    },
  });
}
...
> = {
  dragon: { left: null as any, right: null as any },
  tie: { left: null as any, right: null as any },
  tiger: { left: null as any, right: null as any },
};
...
function updateScore(key: "dragon" | "tie" | "tiger", left: number, right: number) {
